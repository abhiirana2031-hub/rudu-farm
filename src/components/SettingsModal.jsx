...
export const SettingsModal = () => {
  const { activeModal, setActiveModal, rateRules, updateRateRules, sessionConfig, updateSessionConfig, resetAllData, currentUser, setCurrentUser, fast2smsApiKey, setFast2smsApiKey, currentRole } = useFarm();
  ...
  useEffect(() => {
    if (activeModal === 'settings' && !isFarmerRole) {
      ...
      <div className="modal-content" style={{ maxWidth: '460px' }}>
        <div className="modal-header">
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            {isFarmerRole ? <User size={18} /> : <Sliders size={18} />}
            <h3 style={{ margin: 0, fontSize: '16px', fontWeight: '800' }}>
              {isFarmerRole ? 'My Profile Settings' : 'System Configurations'}
            </h3>
          </div>
          <button
        ...
        <div className="modal-body" style={{ padding: '24px' }}>
          ...
          {/* Render admin/operator settings ONLY if NOT a farmer */}
          {!isFarmerRole && (
            <>
