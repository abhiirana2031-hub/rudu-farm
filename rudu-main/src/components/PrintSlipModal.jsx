...
export const PrintSlipModal = () => {
  const { activeModal, setActiveModal, selectedSlipEntry, farmers } = useFarm();
        ...
        <div className="modal-body" style={{ background: '#F8FAF9', padding: '20px' }}>
          ...
          <div className="thermal-slip printable-area">
            <div className="header">
              ...
              <div style={{ fontSize: '10px', marginTop: '4px' }}>Kheda Center | Helpline: +91 98000 11122</div>
            </div>
          ...
          <div style={{ display: 'flex', gap: '10px', marginTop: '16px' }}>
            <button onClick={handlePrint} className="btn btn-primary" style={{ flex: 1, justifyContent: 'center', padding: '12px' }}>
            ...
            >
              {copied ? <Check size={16} color="#FFFFFF" /> : <WhatsAppIcon size={16} />}
              {copied ? 'WhatsApp Sent!' : 'WhatsApp'}
            </button>
          </div>
        </div>
      </div>
