  ...
  const getRoleNotifications = () => {
    const adminNotifs = [
      {
        ...
        desc: '₹12,450 payment settled for Ramesh Yadav (RF1024) via State Bank of India direct deposit.',
        time: '15 mins ago',
        icon: DollarSign,
        iconColor: '#22C55E',
      ...
      },
      {
        ...
        desc: 'Today\'s morning shift milk entry reached a peak of 345.5 Liters logged by operator Amit Kumar.',
        time: '1 hour ago',
        icon: Milk,
        iconColor: '#2563EB',
    ...
    const employeeNotifs = [
      {
        ...
        desc: 'Saved 12.5L Cow Milk collection for Ramesh Yadav. Slip #SLIP-1025 print request sent.',
        time: '5 mins ago',
        icon: Milk,
        iconColor: '#22C55E',
        bgColor: 'rgba(34, 197, 94, 0.1)'
      },
      {
        ...
        desc: 'Collection rates synchronised with Kheda central server. Check sliders for new margins.',
        time: '1 hour ago',
        icon: Sliders,
        iconColor: '#FF9F00',
        bgColor: 'rgba(255, 159, 0, 0.1)'
    ...
    const farmerNotifs = [
      ...
      },
      {
        ...
        desc: '12.5 Liters of milk supply was logged at Kheda Dairy Center. Fat 4.2% | SNF 8.5%.',
        time: '3 hours ago',
        icon: Milk,
        iconColor: '#2563EB',
        bgColor: 'rgba(37, 99, 235, 0.1)'
