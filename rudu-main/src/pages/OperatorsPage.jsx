...
export const OperatorsPage = () => {
  const { employees, deleteEmployee, setActiveModal, entries } = useFarm();
        ...
        <div style={{ display: 'flex', background: '#E2E8F0', padding: '4px', borderRadius: '12px', gap: '4px' }}>
          <button
            ...
            style={{
              ...
              color: viewMode === 'cards' ? '#4E2A18' : 'var(--text-muted)',
          ...
          <button
            ...
            style={{
              ...
              color: viewMode === 'table' ? '#4E2A18' : 'var(--text-muted)',
